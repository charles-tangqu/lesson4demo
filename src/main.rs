pub fn main() {
    println!("------ Q1: Traffic Light Trait ------");
    ...
    // Question 2
    println!("------ Q2: Sum of Vec ------");

    let normal_vec = vec![1, 2, 3, 4, 6, 10, 123124123, 1231231];
...
// Question 2
pub fn sum_of_vec(some_vec: &[u32]) -> Option<u32> {
